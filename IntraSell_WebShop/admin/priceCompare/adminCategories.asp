...
if idKat <> "" then
	...
	butArr(3,2) = "adminCategories.asp"
	butArr(1,1) = "Keywords"
	...
	if edit = "" then
		...
		if edit = "Sub" then
			...
			if rsKat.BOF and rsKat.EOF then
				...
				While not rsKat.EOF
					DisplayCategoryInTab rsKat("Name"), 0, rsKat("ArtKatNr"), "", "adminCategories.asp", idKat
					GetSubCategoriesInTab rsKat("ArtKatNr"), 1, "", "adminCategories.asp", idKat
					rsKat.MoveNext
				wend
				rsKat.close
				set rsKat = nothing
