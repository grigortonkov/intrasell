...
public function ListUserQueries()
				...
				SQL= "select QueryId, SQLDescription, " & _ 
				     "'<a href=default.asp?pageToShow=ShowUserQuery&action=run&queryId=' & queryId &  '>" & _ 
				     " <font color=blue>Ergebnisliste zeigen</font></a>' as Aktion, " & _
				     "'<a href=default.asp?pageToShow=ShowUserQuery&action=deactivate&queryId=' & queryId &  '>" & _ 
				     " <font color=black>Autoemail deaktivieren</font></a>' as AutomatischeEmail, " & _  				     
				     "'<a href=default.asp?pageToShow=ShowUserQuery&action=dilit&queryId=' & queryId &  '>" & _ 
				     ...
				     "'<a href=default.asp?pageToShow=ShowUserQuery&action=run&queryId=' & queryId &  '>" & _ 
				     " <font color=blue>Ergebnisliste zeigen</font></a>' as Aktion, " & _
				     "'<a href=default.asp?pageToShow=ShowUserQuery&action=activate&queryId=' & queryId &  '>" & _ 
