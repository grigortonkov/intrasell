<%     
    ...
    If Len(whereClause) <= Len(DEFAULT_PRODUCT_SEARCH_WHERE) Then
        Response.Write(drawErrorBox(getTranslation("Suche ohne Kriterien"), _
                                     getTranslation("Sie haben ohne Kriterien gesucht! M&ouml;chten Sie jetzt Kriterien festlegen?"), "default.aspx", ""))
    Else
