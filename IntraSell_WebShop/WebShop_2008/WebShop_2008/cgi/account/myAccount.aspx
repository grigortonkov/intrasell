...
<table width="100%">
    ...
    <tr>
        <td width="36%" align="left" style="" height="1">
            ...
            <a href="default.aspx?pageToShow=MyReferedSells&amp;orderType=RE">Verkaeufe </a>nach
            Ihrer Empfehlung
            <br>
            <img border="0" src="<%=imageFullName("arrow.gif")%>" alt="&gt;" />
            <a href="module_ref_ShowMyProducts.asp?idnr=<%=getLOGIN()%>">new Meine sechs Produkte</a>
            <br>
            <img border="0" src="<%=imageFullName("arrow.gif")%>" alt="&gt;" />
            <a href="module_ref_ShowMyProductsAdmin.asp?idnr=<%=getLOGIN()%>">new Meine sechs Produkte
                (Administration)!</a>
        </td>
    </tr>
</table>
