...
<script language="VB" runat="server">  
    ...
    Public Function makeProductPageWithTemplate(ByVal ArtNr As String, ByRef productTemplate As String) As String
        ...
        If IsNothing(productTemplate) Then
            Return "Es wurde keine Template übergeben!"
        End If
        
         Dim Sql As String = " SELECT Firma, lieferantenAdressen.Picture as FirmaImage, lieferantenAdressen.web as HerstellerLink, " & _
    ...
    Public Function getLagerInfoIcon(ByVal ArtNR As Object) As String
        ...
        Return "<a href='cgi/lager/lagerInfoLegend.aspx' target='_new'><img src='" & img & "' alt='" + getTranslation(info) + "' alt='" & info  & "' /></a>"
    End Function
