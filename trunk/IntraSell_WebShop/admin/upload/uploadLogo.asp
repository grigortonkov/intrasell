...
%>
<FORM name="UploadLogo" action="uploadLogo.asp" method="POST" enctype="multipart/form-data">
<center>
<h3><b>Firmenlogo Upload</b></h3>
<p>(Das ist die Abbildung, die links oben im Shop ist.&nbsp;<br>
 Noch wird diese
als Logo für die Rechnungen verwendet)</p>
<table border="0" cellpadding="0" cellspacing="0" width="600" height="1">
<tr>
<td colspan="2">
<p align="center">&nbsp;Aktuelles Logo: <img border="0" src="../../company/images/<%=varvalue("COMPANY_LOGO_IMAGE")%>">
</td>
</tr>
<tr><td align="right" height="8"><b><i>neues Logo ( *.gif ) :</i></b></td>
<td align='center' height="8"><input type='file' name='fName' enctype='multipart/form-data' style='width:350' accept='image/*'></td></tr>
<tr><td colspan="2" height="1">&nbsp;</td></tr>
<td colspan="2" align="center" height="1"><input type="submit" name="UploadButton" value="Upload Logo" onClick="return Validator()" style='width:150'></td>
</table></center></form>
