...
<p align="center">
    <font color="red">Incorect Old Password! Try Again!</font></p>
<%  End If%>
<form method="POST" action="default.aspx?pageToShow=MyAccount" id="formCPWD" name="formCPWD">
<center>
    <table border="0" align="center" cellpadding="2" width="397">
        ...
        <tr>
            ...
            <td width="175">
                <input type="password" name="OldPasswd" size="20">
            </td>
        </tr>
        <tr>
            <td align="right" width="204">
        ...
        <tr>
            ...
            <td width="175">
                <input type="password" name="CNewPasswd" size="20">
            </td>
        </tr>
        <tr>
