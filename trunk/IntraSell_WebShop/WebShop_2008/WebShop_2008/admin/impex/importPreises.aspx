...
%>
<form method="POST" action="importPreises.aspx">
<h1>
    IMPORT&nbsp;</h1>
<p>
    <textarea rows="7" name="ImportData" cols="100000">
...
<p>
    <input type="submit" value="Abschicken" name="B1"><input type="reset" value="Zur¸cksetzen"
        name="B2"></p>
<p>
    Help:<br>
