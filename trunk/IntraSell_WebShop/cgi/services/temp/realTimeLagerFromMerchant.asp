...
'for ingram 
'https://ec.ingrammicro.de/cgi-bin/avail/avail.pl?CCD=AT&BNR=28&KNR=134550&PWD=XXXX&SKU=765Z116
'https://ec.ingrammicro.de/cgi-bin/avail/avail.pl?CCD=AT&BNR=28&KNR=134550&PWD=XXXX&SKU=765Z116
...
if cint(LieferantNr) = 1 then 'ingram 
 lagerinfoURL = "https://ec.ingrammicro.de/cgi-bin/avail/avail.pl?CCD=AT&BNR=28&KNR=134550&PWD=XXXX&SKU=" & ArtikelNrLieferant
end if 
...
'response.Write "lagerinfoURL: " & lagerinfoURL
...
if UrlShop="" then 
	call drawErrorBox("Keine Shopumleitung", "Dieser Lieferant hat keine Shopumleitung aktiviert! " & _ 
					  " M&ouml;chten Sie anstatt das die Homepage diesen Lieferanten besuchen?", _
