...
function addItem(idItem, text, hint, location, altLocation)
{
	...
	if (n)
	{
		...
		MENUitem += " class=clsMenuItemNS onmouseover=\"displaySubMenu('"+idItem+"')\" onclick=\"return false;\">";
...
//        submenu.top  = calculateSumOffset(menu, 'offsetTop') + menu.offsetHeight ; //30;
		...
		topY = 73; //calculateSumOffset(menu, 'offsetTop') - document.body.scrollTop ;
...
function hideAll()
{
	...
	if (ie) {
		if ( document.all["sortBy"] != null ) document.all["sortBy"].style.visibility = fShow ; 
	}
}
