...
Response.Write "<form name=""Products"" action=""adminProdukts.aspx" & qString & """ method=""POST"">"
if ArtNr <> "" and ArtKatNr <> "" then 
	...
	if rsArt.BOF and rsArt.EOF then ' no produkts
		...
		for i = start to final
			...
			Response.Write "<td align='center'><a href='adminCategoriesKeywords.aspx" & qString & "&KatNr=" & rsArt("ArtKatNr") & "'>Edit Category Keywords</a></td>"	
			...
			if rsKat.BOF and rsKat.EOF then ' no keywords
				...
				Response.Write "<a href='adminProdukts.aspx" & qString & "&KatNr=" & rsArt("ArtKatNr") & "&ArtNr=" & rsArt("ArtNr") & "'>Edit Keyword values</a>"
			end if		
