...
#Region " Vom Web Form Designer generierter Code "
    ...
    End Sub
    Protected WithEvents cb_DND As System.Web.UI.WebControls.CheckBox
    ...
    Protected WithEvents rb_PayMethod As System.Web.UI.WebControls.RadioButtonList
    ...
    Protected WithEvents txt_Meeting As System.Web.UI.WebControls.TextBox
...
#End Region
    ...
    Private Sub DataGrid_Meetings_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrid_Meetings.SelectedIndexChanged
        Me.txt_Meeting.Text = Me.DataGrid_Meetings.SelectedItem.Cells(0).Text
    End Sub
    ...
    Private Sub Submit_Form_ServerClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Submit_Form.ServerClick
        ...
        Try
            'Meetings 
            Dim drM As DataSet_Members.Member_MeetingsRow = Me.objMembers.Tables("Member_Meetings").NewRow()
            drM.Member = Me.Member.Text
            drM.Meeting = Me.txt_Meeting.Text

            Me.objMembers.Tables("Member_Meetingss").Rows.Add(drM)
            Me.OleDbDataAdapter_MemberMeetings.Update(Me.objMembers)
        Catch
            Response.Write(Err.Description)
        End Try

        'Save PayMethod and DND 
        ...
        Try
            ...
            drM.PaymentMethod = Me.rb_PayMethod.SelectedValue
            drm.Privacy_Option = Me.cb_DND.Checked
        ...
        Me.OleDbConnection.Close()
        Response.Redirect("newAccount_Step3.aspx?Id1=" & Me.Member.Text)
    End Sub
End Class
