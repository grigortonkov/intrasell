...
<!--#include file="impex/functionsImpEx.aspx"-->
<%
...
if merch = "" then
	...
	butArr(2,1) = "Imported"
	butArr(2,2) = "adminImportedPrices.aspx"
	...
	if IDtoAdd <> "" then
		...
		if katNr <> "" then
			...
			While not rsOther.EOF
				DisplayCategory rsOther("Name"), 0, rsOther("ArtKatNr"), qString, "adminImportPrices.aspx"
				GetSubCategories rsOther("ArtKatNr"), 1, qString, "adminImportPrices.aspx"
				rsOther.MoveNext
			wend
