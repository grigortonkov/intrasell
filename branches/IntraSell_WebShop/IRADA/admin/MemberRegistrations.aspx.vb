Public Class MemberRegistrations
...
#Region " Vom Web Form Designer generierter Code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'OleDbSelectCommand3
        '
        Me.OleDbSelectCommand3.CommandText = "SELECT Members.* FROM (Member_Events INNER JOIN Members ON Member_Events.Member =" & _
        " Members.ID) WHERE (Member_Events.Event = ?)"
        Me.OleDbSelectCommand3.Connection = Me.OleDbConnection
        Me.OleDbSelectCommand3.Parameters.Add(New System.Data.OleDb.OleDbParameter("Event", System.Data.OleDb.OleDbType.Integer, 0, "Event"))
        '
        'OleDbUpdateCommand3
        '
        ...
        'OleDbSelectCommand4
        '
        Me.OleDbSelectCommand4.CommandText = "SELECT Members.* FROM (Member_Meetings INNER JOIN Members ON Member_Meetings.Memb" & _
        "er = Members.ID1) WHERE (Member_Meetings.Meeting = ?)"
        Me.OleDbSelectCommand4.Connection = Me.OleDbConnection
        Me.OleDbSelectCommand4.Parameters.Add(New System.Data.OleDb.OleDbParameter("Meeting", System.Data.OleDb.OleDbType.Integer, 0, "Meeting"))
        '
        'OleDbUpdateCommand4
        '
        ...
        "d) AS Registrations FROM (Meetings INNER JOIN Member_Meetings ON Meetings.Id = M" & _
        "ember_Meetings.Meeting) GROUP BY Meetings.Description, Meetings.Id, Meetings.Pri" & _
        "ce"
    ...
    Protected WithEvents DataGrid_Meetings As System.Web.UI.WebControls.DataGrid
    Protected WithEvents DataGrid_Events As System.Web.UI.WebControls.DataGrid
    Protected WithEvents DataGrid_Members As System.Web.UI.WebControls.DataGrid
...
#End Region
    ...
    Private Sub DataGrid_Meetings_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrid_Meetings.SelectedIndexChanged
        Try
            Me.objMembers.EnforceConstraints = False
            Me.OleDbConnection.Open()
            Dim meeting As String = Me.DataGrid_Meetings.SelectedItem.Cells(0).Text
            Me.OleDbDataAdapter_MemberMeetings.SelectCommand.Parameters("Meeting").Value = meeting
            Me.OleDbDataAdapter_MemberMeetings.Fill(Me.objMembers, "Members")
            Me.OleDbConnection.Close()
    ...
    Private Sub DataGrid_Events_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrid_Events.SelectedIndexChanged
        Try
            Me.objMembers.EnforceConstraints = False
            Me.OleDbConnection.Open()
            Dim eventSel As String = Me.DataGrid_Events.SelectedItem.Cells(0).Text
            Me.OleDbDataAdapter_MemberEvents.SelectCommand.Parameters("Event").Value = eventSel

            Me.OleDbDataAdapter_MemberEvents.Fill(Me.objMembers, "Members")
            Me.OleDbConnection.Close()
