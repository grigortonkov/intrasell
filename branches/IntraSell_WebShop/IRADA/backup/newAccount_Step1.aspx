		...
		<form id="Form1" method="post" runat="server">
				...
				<TABLE id="table1" cellSpacing="0" cellPadding="0" width="500" border="0">
					<TR>
						...
						<TD width="100" colSpan="2">&nbsp;
							<asp:TextBox id="MODE" runat="server" Width="52px" BorderStyle="None"></asp:TextBox>
							<asp:TextBox id="ID1" runat="server" Width="13px" BorderStyle="None"></asp:TextBox></TD>
					</TR>
					<TR>
					...
					<TR>
						...
						<TD width="100" colSpan="2">Confirm Password:</TD>
					</TR>
					<TR>
						<TD width="165">
					...
					<TR>
						...
						<TD width="176">Middle Initial:</TD>
						<TD width="100" colSpan="2">Last Name:</TD>
					</TR>
					<TR>
						<TD width="165">
					...
					<TR>
						...
						<TD width="176">Year Graduated:</TD>
						<TD width="100" colSpan="2">School:</TD>
					</TR>
					<TR>
						<TD width="165">
					...
					<TR>
						...
						<TD width="176">&nbsp;</TD>
						<TD width="100" colSpan="2">Type of practice:</TD>
					</TR>
					<TR>
			...
			<DIV align="center">
				<TABLE id="table6" cellSpacing="0" cellPadding="0" width="500" border="0">
					...
					<TR>
						<TD width="497" bgColor="#f3f3f3" colSpan="3">
							<asp:RadioButtonList id="Radio_register_type" runat="server" Width="446px">
