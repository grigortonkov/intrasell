...
<HTML>
	...
	<body MS_POSITIONING="FlowLayout">
		<form id="Form1" method="post" runat="server">
			<B>
				<asp:Panel id="PanelLogin" runat="server" BackColor="Gainsboro">
							...
							<P>
								<asp:Panel id="PanelMember" runat="server" Width="662px" Visible="False" BackColor="White">
									...
									<P>since
										...
										<asp:Label id=DatePaidTo runat="server" Text='<%# DataBinder.Eval(objMembers, "Tables[Members].DefaultView.[0].CreationTime") %>' Visible="False" Font-Bold="True">
										</asp:Label></P>
									<P><FONT color="#ff0000">&nbsp; </FONT>
										<asp:LinkButton id="btn_renew" runat="server">renew my membership </asp:LinkButton></P>
								</asp:Panel>
						</TD>
					</TR>
					<TR>
			...
			<P></TD></TR><TR>
				...
				&nbsp;<TR>
					<asp:LinkButton id="LinkButton4" runat="server">Change Password</asp:LinkButton><TD width="236">&nbsp;</TD>
					&nbsp;&nbsp;<TD width="92">&nbsp;</TD>
					&nbsp;&nbsp;<TD width="170">
				&nbsp;&nbsp;
			</P>
