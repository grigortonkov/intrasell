		...
		<form id="Form1" method="post" runat="server">
			...
			<DIV align="center">
				<TABLE id="table18" cellSpacing="0" cellPadding="0" width="500" border="0">
					...
					<TR>
						<TD width="167">&nbsp;
							<asp:TextBox id="txt_Meeting" runat="server" Width="101px" Height="19px" Visible="False"></asp:TextBox></TD>
						<TD width="162">&nbsp;
							<asp:TextBox id="txt_Event" runat="server" Width="82px" Height="19px" Visible="False"></asp:TextBox></TD>
