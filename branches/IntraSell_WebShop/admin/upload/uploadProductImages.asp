...
%>
<FORM name="UploadproductImages" action="uploadproductImages.asp" method="POST" enctype="multipart/form-data">
<input type="hidden" name="NumOfProducts" value="<%=NumOfProducts%>">
<center>
<h3><b>Produktbilder Upload Formular</b></h3>
<table border="0" cellpadding="0" cellspacing="0" width="800" height="1">
<tr height="12%">
	<td align="center" height="4" valign="middle" width="26"><b>#</td>
	<td align="center" colspan="2" height="4" valign="middle" width="643"><b>
	Füllen Sie die ArtNr des Produktes aus oder wählen Sie ein Produkt aus der Liste!
	<!--Fill in ProductID or select a Product from the list--></b></td>
	<td align="center" height="4" valign="middle" width="242"><b>Wählen sie
      eine Datei (pflicht)</b></td>
</tr>	
<%For count = 1 to NumOfProducts
...
Next
%>
<tr><td colspan="4" height="1" width="915">&nbsp;</td></tr>
<tr><td height="26" width="26">&nbsp;</td><td colspan="3" align="center" height="26" width="887"><input type="submit" name="UploadButton" value="Upload allle Bilder" onClick="return Validator()" style='width:150'></td>
</table></center></form>